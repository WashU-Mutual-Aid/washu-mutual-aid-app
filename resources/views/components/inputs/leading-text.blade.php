...
<div class="mt-1 {{ $wrap }} rounded-md shadow-sm">
    ...
    <input
        ...
        class="
            appearance-none flex-1 block w-full px-3 py-2 border rounded-none rounded-r-md focus:outline-none transition duration-150 ease-in-out sm:text-sm sm:leading-5
            @error($name)
