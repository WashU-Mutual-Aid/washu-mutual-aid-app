...
@endsection
@section('content')
    <div class="-mx-5 -my-6 bg-gray-100 px-5 py-6 rounded-lg shadow sm:-mx-6 sm:px-6">
        <div>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-600">
                            This information will be displayed for other users to see.
                        </p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                                ...
                                <div class="mt-6 grid grid-cols-1 row-gap-6 col-gap-4 sm:grid-cols-6">
                                    <div class="sm:col-span-3">
                                        <x-inputs.basic-select name="affiliation">
                                            ...
                                            <option @if($user->affiliation === 'Undergraduate') selected @endif value="Undergraduate">Undergraduate</option>
                                            <option disabled>---</option>
                                            <option disabled>Graduate</option>
                                            <option @if($user->affiliation === 'Arts & Sciences') selected @endif value="Arts & Sciences">Arts &amp; Sciences</option>
                                            <option @if($user->affiliation === 'Brown School') selected @endif value="Brown School">Brown School</option>
                                            <option @if($user->affiliation === 'McKelvey School of Engineering') selected @endif value="McKelvey School of Engineering">McKelvey School of Engineering</option>
                                            <option @if($user->affiliation === 'Olin Business School') selected @endif value="Olin Business School">Olin Business School</option>
                                            <option @if($user->affiliation === 'Sam Fox School of Design &  Visual Arts') selected @endif value="Sam Fox School of Design &  Visual Arts">Sam Fox School of Design &amp; Visual Arts</option>
                                            <option @if($user->affiliation === 'School of Law') selected @endif value="School of Law">School of Law</option>
                                            <option @if($user->affiliation === 'School of Medicine') selected @endif value="School of Medicine">School of Medicine</option>
                                            <option disabled>---</option>
                                            <option @if($user->affiliation === 'Alumni') selected @endif value="Alumni">Alumni</option>
                                    ...
                                    <div class="sm:col-span-3">
                                        <x-inputs.basic-select name="current_location">
                                            ...
                                            <option @if($user->current_location === 'St. Louis City/County') selected @endif value="St. Louis City/County" selected>St. Louis City/County</option>
                                            <option @if($user->current_location === 'Other') selected @endif value="Other">Other</option>
                                        </x-inputs.basic-select>
                                    </div>
                                </div>
